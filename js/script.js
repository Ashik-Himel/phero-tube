      ...
      data.data.forEach(item => {
        ...
        card.innerHTML = `
          <div class="relative w-full">
            <img class="w-full aspect-[4/3] object-cover rounded-lg" src="${item.thumbnail}" alt="Thumbnail">
            <span class="absolute right-2 bottom-2 bg-gray-800 text-white py-1 px-2 rounded-md">${secondToHourMinute(item.others.posted_date)}</span>
          </div>
          <div class="flex justify-start items-start gap-4 p-4">
            <img class="w-10 h-10 object-cover rounded-full" src="${item.authors[0].profile_picture}" alt="Profile Picture">
            <div class="flex-1">
              ...
              <div class="flex justify-start items-center gap-2 mb-1">
                ...
                ${item.authors[0].verified ? '<img class="w-4" src="images/varification_check_mark.jpg" alt="Verification Icon">' : ''}
              </div>
